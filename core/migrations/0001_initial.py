# Generated by Django 5.1.5 on 2025-01-27 04:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, max_digits=18)),
                ('date', models.DateField()),
                ('category', models.CharField(choices=[('Software', 'Software'), ('Travel', 'Travel'), ('Salaries', 'Salaries'), ('Other', 'Other')], max_length=100)),
                ('description', models.TextField(blank=True, null=True)),
