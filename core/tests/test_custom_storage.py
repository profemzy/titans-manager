...
class AzureReceiptStorageTest(TestCase):
    ...
    def test_get_valid_name(self):
        ...
        self.assertEqual(self.storage.get_valid_name("test file.pdf"), "test_file.pdf")

        # Test removing special characters
        self.assertEqual(self.storage.get_valid_name("test@#$%^&*.pdf"), "test.pdf")
        ...
        self.assertEqual(self.storage.get_valid_name("résumé.pdf"), "rsum.pdf")
    ...
    def test_get_available_name_max_length(self, mock_exists):
        ...
        with patch("core.custom_storage.datetime") as mock_datetime:
            ...
            result = self.storage.get_available_name(
                "very_long_filename_that_exceeds_limit.pdf", max_length=30
            )
